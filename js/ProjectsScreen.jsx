const {Card,Badge,Tag,Icon}=window.RivernateDesignSystem_665cb5;

function ProjectsScreen(){
  const projects=window.RN_DATA.projects;
  return (<div style={{display:'flex',flexDirection:'column',gap:'var(--sp-6)'}}>
    ...
    {projects.length?(
      ...
      <div style={{padding:'var(--sp-6) 0',color:'var(--text-faint)'}}>nothing public yet.</div>
    )}
  </div>);
}
